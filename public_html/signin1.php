    ...
    <div  class='container'>
      <nav style='background-color: #87CEEB;' id='navigation1' class='navigation'>
        ...
        <div class='nav-header'>
          <a style='color: rgb(0, 0, 0);font-size: 30px; ' class='nav-brand' href='#'>Codding Snippets</a> 
...
<br>
  ...
  <div style='background-color; '>
      <div id ='left'>  
    <a href='#'><img src='https://cdn.dribbble.com/users/1787323/screenshots/7123758/media/5c2b6b54ae3d5eabd56679e63ed83eaa.png?compress=1&resize=400x300' width='50%'  height='auto'></a>
     </div>
  <br>
  <br>
